...
impl MyGame {
    fn draw_canvas(&mut self, ctx: &mut Context) -> GameResult {
        ...
        graphics::draw(
            ...
            &self.ground,
            (
                na::Point2::new(0., VIRTUAL_HEIGHT as f32 - 16.),
                0.0,
                graphics::WHITE,
            ),
        )?;
        ...
        let rect = graphics::Mesh::new_rectangle(
            ...
            graphics::Rect::new(0., 0., VIRTUAL_WIDTH as f32, VIRTUAL_HEIGHT as f32),
            graphics::WHITE,
        )?;
...
impl EventHandler for MyGame {
    ...
    fn draw(&mut self, ctx: &mut Context) -> GameResult {
        ...
        let scale = na::Vector2::new(X_RATIO, Y_RATIO);
